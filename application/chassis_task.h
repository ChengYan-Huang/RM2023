...
//底盘3508最大can发送电流值
#define MAX_MOTOR_CAN_CURRENT 32000.0f
...
//底盘运动过程最大前进速度
#define NORMAL_MAX_CHASSIS_SPEED_X 1.8f//1.1
//chassis left or right max speed
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 1.5f//0.9
...
typedef struct
{
  ...
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
	pid_type_def revolve_pid;                    //小陀螺旋转pid
